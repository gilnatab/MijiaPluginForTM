...
*
* 来源: https://github.com/zhongyang219/TrafficMonitor/blob/master/include/PluginInterface.h
* API Version: 7
*************************************************************/
#pragma once
#include <Windows.h>
...
public:
    ...
    enum ExtendedInfoIndex
    {
        ...
        EI_CONFIG_DIR,  // 配置文件目录，通过 OnExtenedInfo 传入
    };
    ...
    virtual int IsCommandChecked(int command_index) { return 0; }

    // API version 7: 插件初始化，主程序传入 ITrafficMonitor*
